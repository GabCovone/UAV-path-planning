...
dir_report = fullfile('UAV-path-planning/reports agenti', nome_agente_file);
...
agent_name = 'agent'; 
dati_salvati = load(nome_agente_file, agent_name);
